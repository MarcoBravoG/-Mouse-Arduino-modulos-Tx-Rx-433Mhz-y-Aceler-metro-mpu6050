...
uint8_t r = 0;
uint8_t g = 0;  //x si es positivo derecha si es negativo izquierda
uint8_t b = 0;  //y si es positivo abajo si es negativo arriba
...
void loop() {
  ...
  if(radio.recv(data, &dataLength)){
    ...
    b = (data[2]-1022); //A3
     ...
     Serial.print(" izq: ");  // imprime Mensaje:
     Serial.print(r);   // imprime buffer de mensaje     
     Serial.print(" x: ");  // imprime Mensaje:
     Serial.print(g);   // imprime buffer de mensaje     
     Serial.print(" y: ");  // imprime Mensaje:
...
int xReading = g;  //je x 2
int yReading = b; //eje y
...
// si x es positivo desplzamiento >>>> derecha
// si x es negativo desplzamiento <<<< derecha
// si y es negativo desplazamiento hacia arriba
// si y es positivo desplazamieno haca abjo
// el tercer valor es scroll
